...
// Paints the L-System by going through the states. 
 ...
 public class main : MonoBehaviour { 
 	...
 	private LinkedList<current> _StateList; 
 	public LinkedList<current> StateList { 
 	...
 	public void create(LinkedList<current> states) { 
 	...
 	void renderState(current state, float newAngle) { 
 		points.Clear(); 
 		foreach(char character in state.State) { 
 			switch(character) { 
 	...
 	//	} 
 		...
 		if(points.First != null) { 
 			...
 			while(currentNode.Next != null) { 
 				Debug.DrawLine(currentNode.Value, currentNode.Next.Value, Color.white); 
